...
public class Exercicio03 {
	 ...
	 public static void main(String[] args) {
	  ...
	  System.out.printf(" A largura do terreno � : %.1f%n", largura);
	  System.out.printf(" O comprimento do terreno � %.1f%n", comprimento);
	  System.out.printf(" O tamanho da area �: %.2f%n" , tamanhoArea);
	  System.out.printf( " O pre�o da �rea �: %.2f%n",preco);
